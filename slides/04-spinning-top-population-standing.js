// Hand-rolled canvas animation: many spinning tops racing in place, no
// graph/bars yet — just the population, some falling within the
// observation window and some still standing (spinning) at the end of it.
//
